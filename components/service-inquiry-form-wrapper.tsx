...
// The type declaration is already at the bottom of this file, but let's move it to the top for consistency
// Remove the existing declaration at the bottom of the file and add this at the top after imports
declare global {
  interface Window {
